...
describe('favorite blog', () => {
  ...
  test('favorite blog of a bigger list is the blog has most likes', () => {
...
describe('most blogs', () => {
  ...
  test('for a bigger list returns the author who has the largest amount of blogs', () => {
...
describe('most likes', () => {
  ...
  test('of a bigger list returns the author whose blog posts have the largest amount of likes', () => {
